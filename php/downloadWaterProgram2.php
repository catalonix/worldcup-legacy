...
// 데이터베이스에서 데이터 선택
$query = "SELECT L.*,P.PROGRAM_NAME,TIMESTAMPDIFF(MINUTE,L.START_TIME,L.END_TIME) AS USE_TIME FROM WATER_PROGRAM_LOG_V2 L JOIN WATER_PROGRAM_V2 P 
		  USING(PROGRAM_ID,PROGRAM_TIME) ORDER BY PROGRAM_ID,LOG_NO";
