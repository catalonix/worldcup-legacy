...
<div class="main-sidebar main-sidebar-sticky side-menu">
	<div class="sidemenu-logo">
		<a class="main-logo" href="monitoring.html"> <img src="../assets/img/logo.png" class="header-brand-img desktop-logo" alt="logo"> <img
			src="../assets/img/logo-icon.png" class="header-brand-img icon-logo" alt="logo" height="28px">
		</a>
	</div>
	<div class="main-sidebar-body">
		<ul class="nav">
			<li class="nav-item"><a class="nav-link" href="monitoring.html"> <span class="shape1"></span> <span class="shape2"></span> <i
					class="fe fe-grid sidemenu-icon"></i> <span class="sidemenu-label">통합모니터링 요약(그라운드)</span>
			</a></li>
			<li class="nav-item"><a class="nav-link" href="monitoring-equipment.html"> <span class="shape1"></span> <span class="shape2"></span> <i
					class="fe fe-database sidemenu-icon"></i> <span class="sidemenu-label">통합모니터링 요약(장비)</span>
			</a></li>
			<li class="nav-item"><a class="nav-link with-sub" href="#"> <span class="shape1"></span> <span class="shape2"></span> <i
					class="ti-file sidemenu-icon"></i> <span class="sidemenu-label">요약분석 정보</span> <i class="angle fe fe-chevron-right"></i>
			</a>
				<ul class="nav-sub">
					<li class="nav-sub-item"><a class="nav-sub-link" href="ndvi-summary.html">식생지수 정보</a></li>
					<li class="nav-sub-item"><a class="nav-sub-link" href="soil-summary.html">토양관측 정보</a></li>
					<li class="nav-sub-item"><a class="nav-sub-link" href="weather-summary.html">기상센서 정보</a></li>
				</ul></li>
