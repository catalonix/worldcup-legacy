...
var DashboardProgress = function() {
    ...
    return {
        init: function() {
            _ProgressRoundedChart('#hours-available-progress', 38, 2, '#F06292', 0.68, 'icon-starburst text-pink', '미세먼지', '32㎍/㎥');
            _ProgressRoundedChart('#goal-progress', 38, 2, '#5C6BC0', 0.32, 'icon-starburst text-indigo', '초미세먼지', '1002.3㎍/㎥');
        }
    }
}();
